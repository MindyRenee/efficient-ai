...
_ENGINE_MODEL = ModelInfo(
    name="local-engine", tier=CapabilityTier.MICRO, provider="engine",
    param_count_b=0, context_window=100000,
    mmlu_score=0, human_eval=0,
    supports_json=True, supports_tools=False,
    quantization="none", vram_required_gb=0,
    max_output_tokens=4096,
    tags=["summarization", "classification", "extraction", "simple-qa",
          "code-completion", "structured-generation", "embedded", "zero-cost"],
)

# Local models (Ollama) — $0/token, run on your hardware
_LOCAL_MODELS: list[ModelInfo] = [
    ModelInfo(
        name="phi3:mini", tier=CapabilityTier.MICRO, provider="ollama",
        param_count_b=3.8, context_window=128000,
        mmlu_score=68.0, human_eval=62.0,
        supports_json=True, supports_tools=False,
        quantization="Q4_K_M", vram_required_gb=2.3,
        max_output_tokens=4096,
        tags=["classification", "extraction", "validation", "fast"],
    ),
    ModelInfo(
        name="gemma2:9b", tier=CapabilityTier.SMALL, provider="ollama",
        param_count_b=9.0, context_window=8192,
        mmlu_score=71.0, human_eval=60.0,
        supports_json=True, supports_tools=False,
        quantization="Q4_K_M", vram_required_gb=5.5,
        max_output_tokens=4096,
        tags=["summarization", "simple-qa", "fast"],
    ),
    ModelInfo(
        name="qwen2.5:7b", tier=CapabilityTier.SMALL, provider="ollama",
        param_count_b=7.0, context_window=128000,
        mmlu_score=74.0, human_eval=72.0,
        supports_json=True, supports_tools=True,
        quantization="Q4_K_M", vram_required_gb=4.5,
        supports_speculative=True, draft_model="qwen2.5:0.5b",
        max_output_tokens=8192,
        tags=["summarization", "code-completion", "rag", "tools", "fast"],
    ),
    ModelInfo(
        name="llama3.1:8b", tier=CapabilityTier.SMALL, provider="ollama",
        param_count_b=8.0, context_window=128000,
        mmlu_score=73.0, human_eval=72.0,
        supports_json=True, supports_tools=True,
        quantization="Q4_K_M", vram_required_gb=5.0,
        max_output_tokens=8192,
        tags=["summarization", "rag", "tools", "general"],
    ),
    ModelInfo(
        name="deepseek-r1:7b", tier=CapabilityTier.SMALL, provider="ollama",
        param_count_b=7.0, context_window=64000,
        mmlu_score=74.0, human_eval=70.0,
        supports_json=True, supports_tools=False,
        quantization="Q4_K_M", vram_required_gb=4.5,
        max_output_tokens=8192,
    ...
    ModelInfo(
        name="qwen2.5:14b", tier=CapabilityTier.MID, provider="ollama",
        param_count_b=14.0, context_window=128000,
        mmlu_score=79.0, human_eval=78.0,
        supports_json=True, supports_tools=True,
        quantization="Q4_K_M", vram_required_gb=9.0,
        supports_speculative=True, draft_model="qwen2.5:0.5b",
        max_output_tokens=8192,
        tags=["rag", "tool-use", "structured-generation", "code"],
    ),
    ModelInfo(
        name="deepseek-r1:14b", tier=CapabilityTier.MID, provider="ollama",
        param_count_b=14.0, context_window=64000,
        mmlu_score=82.0, human_eval=76.0,
        supports_json=True, supports_tools=False,
        quantization="Q4_K_M", vram_required_gb=9.0,
        max_output_tokens=8192,
    ...
    ModelInfo(
        name="qwen2.5:32b", tier=CapabilityTier.MID, provider="ollama",
        param_count_b=32.0, context_window=128000,
        mmlu_score=83.2, human_eval=84.0,
        supports_json=True, supports_tools=True,
        quantization="Q4_K_M", vram_required_gb=20.0,
        supports_speculative=True, draft_model="qwen2.5:0.5b",
        max_output_tokens=8192,
        tags=["agentic", "complex-reasoning", "code", "rag"],
    ),
    ModelInfo(
        name="llama3.3:70b", tier=CapabilityTier.LARGE, provider="ollama",
        param_count_b=70.0, context_window=128000,
        mmlu_score=83.1, human_eval=82.0,
        supports_json=True, supports_tools=True,
        quantization="Q4_K_M", vram_required_gb=40.0,
        max_output_tokens=8192,
...
_CLOUD_MODELS: list[ModelInfo] = [
    # OpenAI
    ModelInfo(
        name="gpt-4o-mini", tier=CapabilityTier.SMALL, provider="openai",
        context_window=128000,
        input_price_per_m=0.15, output_price_per_m=0.60,
        mmlu_score=82.0, human_eval=87.0,
        supports_tools=True, supports_vision=True, supports_json=True,
        max_output_tokens=16384,
        tags=["general", "fast", "cheap-cloud"],
    ),
    ModelInfo(
        name="gpt-4o", tier=CapabilityTier.LARGE, provider="openai",
        context_window=128000,
        input_price_per_m=2.50, output_price_per_m=10.00,
        mmlu_score=88.0, human_eval=91.0,
        supports_tools=True, supports_vision=True, supports_json=True,
        max_output_tokens=16384,
        tags=["reasoning", "agentic", "vision"],
    ),
    ModelInfo(
        name="gpt-5", tier=CapabilityTier.FRONTIER, provider="openai",
        context_window=256000,
        input_price_per_m=5.00, output_price_per_m=15.00,
        mmlu_score=90.0, human_eval=93.0,
        supports_tools=True, supports_vision=True, supports_json=True,
    ...
    # Anthropic
    ModelInfo(
        name="claude-3-5-haiku", tier=CapabilityTier.SMALL, provider="anthropic",
        context_window=200000,
        input_price_per_m=0.80, output_price_per_m=4.00,
        mmlu_score=80.0, human_eval=83.0,
        supports_tools=True, supports_vision=True, supports_json=True,
        max_output_tokens=8192,
        tags=["general", "fast", "long-context"],
    ),
    ModelInfo(
        name="claude-sonnet-4", tier=CapabilityTier.LARGE, provider="anthropic",
        context_window=200000,
        input_price_per_m=3.00, output_price_per_m=15.00,
        mmlu_score=88.0, human_eval=90.0,
        supports_tools=True, supports_vision=True, supports_json=True,
        max_output_tokens=8192,
        tags=["reasoning", "agentic", "coding", "long-context"],
    ),
    ModelInfo(
        name="claude-opus-4.5", tier=CapabilityTier.FRONTIER, provider="anthropic",
        context_window=200000,
        input_price_per_m=15.00, output_price_per_m=75.00,
        mmlu_score=92.0, human_eval=95.0,
        supports_tools=True, supports_vision=True, supports_json=True,
        max_output_tokens=32768,
    ...
    ModelInfo(
        name="llama-3.3-70b-versatile", tier=CapabilityTier.LARGE, provider="groq",
        context_window=128000,
    ...
    ModelInfo(
        name="deepseek-v4-flash", tier=CapabilityTier.MID, provider="groq",
        context_window=64000,
        input_price_per_m=0.14, output_price_per_m=0.28,
        mmlu_score=80.0, human_eval=78.0,
        supports_tools=True, supports_json=True,
        max_output_tokens=8192,
    ...
    ModelInfo(
        name="deepseek/deepseek-v4-flash", tier=CapabilityTier.MID, provider="openrouter",
        context_window=64000,
        input_price_per_m=0.14, output_price_per_m=0.28,
        mmlu_score=80.0, human_eval=78.0,
        supports_tools=True, supports_json=True,
    ...
    ModelInfo(
        name="qwen/qwen-4-72b", tier=CapabilityTier.LARGE, provider="openrouter",
        context_window=128000,
        input_price_per_m=0.45, output_price_per_m=1.20,
        mmlu_score=84.0, human_eval=86.0,
        supports_tools=True, supports_json=True,
        max_output_tokens=8192,
...
def best_local_model_for_vram(vram_gb: float, tier: CapabilityTier | None = None) -> ModelInfo | None:
