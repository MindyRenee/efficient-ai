        ...
        resp = client.post(
            ...
            json={
                ...
                "messages": [
                    {
                        "role": "user",
                        "content": "Summarize: The weather today is sunny with a high of 75 degrees and light winds from the west. Tomorrow will bring rain showers in the afternoon.",
                    }
                ],
            },
        )
